...
// export default function EmployeePage({ name }) {
...
//       const partialDelivery = await getAllPartialDelivery(userId);
//       debugger
...
//                         <React.Fragment key={collectionPoint.id}>
//                           <TableRow onClick={() => handleRowClick(index)}>
//                             <TableCell>{index + 1}</TableCell>
//                             <TableCell>{collectionPoint.id}</TableCell>
//                             <TableCell>{collectionPoint.address}</TableCell>
//                           </TableRow>
//                           {expandedRow === index && (
//                             <TableRow>
//                               <TableCell colSpan={3}>
...
//                                     </TableHead>
//                                     <TableBody>
//                                       {collectionPoint.packages.map((packageData) => (
